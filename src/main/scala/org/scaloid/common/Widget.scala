...
trait WidgetFamily {
  ...
  trait TraitView[V <: android.view.View] extends ConstantsSupport {
    ...
    @noEquivalentGetterExists
    @inline def backgroundColor(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'backgroundColor'")
    @inline def backgroundColor  (p: Int) =            backgroundColor_=  (p)
    @inline def backgroundColor_=(p: Int) = { basis.setBackgroundColor    (p); basis }

    @noEquivalentGetterExists
    @inline def backgroundDrawable(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'backgroundDrawable'")
    ...
    @noEquivalentGetterExists
    @inline def backgroundResource(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'backgroundResource'")
    ...
    @noEquivalentGetterExists
    @inline def fadingEdgeLength(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'fadingEdgeLength'")
    ...
    @noEquivalentGetterExists
    @inline def minimumHeight(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'minimumHeight'")
    @inline def minimumHeight  (p: Int) =            minimumHeight_=  (p)
    @inline def minimumHeight_=(p: Int) = { basis.setMinimumHeight    (p); basis }

    @noEquivalentGetterExists
    @inline def minimumWidth(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'minimumWidth'")
    ...
    @noEquivalentGetterExists
    @inline def onClickListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onClickListener'")
    ...
    @noEquivalentGetterExists
    @inline def onCreateContextMenuListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onCreateContextMenuListener'")
    ...
    @noEquivalentGetterExists
    @inline def onKeyListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onKeyListener'")
    ...
    @noEquivalentGetterExists
    @inline def onLongClickListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onLongClickListener'")
    ...
    @noEquivalentGetterExists
    @inline def onTouchListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onTouchListener'")
    ...
    @noEquivalentGetterExists
    @inline def scrollContainer(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'scrollContainer'")
  ...
  trait TraitTextView[V <: android.widget.TextView] extends TraitView[V] {
    ...
    @noEquivalentGetterExists
    @inline def cursorVisible(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'cursorVisible'")
    @inline def cursorVisible  (p: Boolean) =            cursorVisible_=  (p)
    @inline def cursorVisible_=(p: Boolean) = { basis.setCursorVisible    (p); basis }

    @noEquivalentGetterExists
    @inline def editableFactory(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'editableFactory'")
    ...
    @noEquivalentGetterExists
    @inline def ems(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'ems'")
    ...
    @noEquivalentGetterExists
    @inline def extractedText(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'extractedText'")
    ...
    @noEquivalentGetterExists
    @inline def highlightColor(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'highlightColor'")
    ...
    @noEquivalentGetterExists
    @inline def hintTextColor(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'hintTextColor'")
    ...
    @noEquivalentGetterExists
    @inline def horizontallyScrolling(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'horizontallyScrolling'")
    ...
    @noEquivalentGetterExists
    @inline def includeFontPadding(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'includeFontPadding'")
    ...
    @noEquivalentGetterExists
    @inline def inputExtras(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'inputExtras'")
    ...
    @noEquivalentGetterExists
    @inline def lines(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'lines'")
    @inline def lines  (p: Int) =            lines_=  (p)
    @inline def lines_=(p: Int) = { basis.setLines    (p); basis }

    @noEquivalentGetterExists
    @inline def linkTextColor(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'linkTextColor'")
    ...
    @noEquivalentGetterExists
    @inline def marqueeRepeatLimit(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'marqueeRepeatLimit'")
    ...
    @noEquivalentGetterExists
    @inline def maxEms(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'maxEms'")
    @inline def maxEms  (p: Int) =            maxEms_=  (p)
    @inline def maxEms_=(p: Int) = { basis.setMaxEms    (p); basis }

    @noEquivalentGetterExists
    @inline def maxHeight(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'maxHeight'")
    @inline def maxHeight  (p: Int) =            maxHeight_=  (p)
    @inline def maxHeight_=(p: Int) = { basis.setMaxHeight    (p); basis }

    @noEquivalentGetterExists
    @inline def maxLines(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'maxLines'")
    @inline def maxLines  (p: Int) =            maxLines_=  (p)
    @inline def maxLines_=(p: Int) = { basis.setMaxLines    (p); basis }

    @noEquivalentGetterExists
    @inline def maxWidth(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'maxWidth'")
    @inline def maxWidth  (p: Int) =            maxWidth_=  (p)
    @inline def maxWidth_=(p: Int) = { basis.setMaxWidth    (p); basis }

    @noEquivalentGetterExists
    @inline def minEms(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'minEms'")
    @inline def minEms  (p: Int) =            minEms_=  (p)
    @inline def minEms_=(p: Int) = { basis.setMinEms    (p); basis }

    @noEquivalentGetterExists
    @inline def minHeight(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'minHeight'")
    @inline def minHeight  (p: Int) =            minHeight_=  (p)
    @inline def minHeight_=(p: Int) = { basis.setMinHeight    (p); basis }

    @noEquivalentGetterExists
    @inline def minLines(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'minLines'")
    @inline def minLines  (p: Int) =            minLines_=  (p)
    @inline def minLines_=(p: Int) = { basis.setMinLines    (p); basis }

    @noEquivalentGetterExists
    @inline def minWidth(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'minWidth'")
    ...
    @noEquivalentGetterExists
    @inline def onEditorActionListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onEditorActionListener'")
    ...
    @noEquivalentGetterExists
    @inline def rawInputType(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'rawInputType'")
    @inline def rawInputType  (p: Int) =            rawInputType_=  (p)
    @inline def rawInputType_=(p: Int) = { basis.setRawInputType    (p); basis }

    @noEquivalentGetterExists
    @inline def scroller(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'scroller'")
    ...
    @noEquivalentGetterExists
    @inline def selectAllOnFocus(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'selectAllOnFocus'")
    ...
    @noEquivalentGetterExists
    @inline def singleLine(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'singleLine'")
    @inline def singleLine  (p: Boolean) =            singleLine_=  (p)
    @inline def singleLine_=(p: Boolean) = { basis.setSingleLine    (p); basis }

    @noEquivalentGetterExists
    @inline def spannableFactory(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'spannableFactory'")
    ...
    @noEquivalentGetterExists
    @inline def textColor(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'textColor'")
    ...
    @noEquivalentGetterExists
    @inline def textKeepState(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'textKeepState'")
  ...
  class STextView(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends TextView(context) with TraitTextView[STextView] {
    def basis = this
  ...
  trait TraitAbsListView[V <: android.widget.AbsListView] extends TraitAdapterView[V] {
    ...
    @noEquivalentGetterExists
    @inline def drawSelectorOnTop(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'drawSelectorOnTop'")
    ...
    @noEquivalentGetterExists
    @inline def filterText(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'filterText'")
    ...
    @noEquivalentGetterExists
    @inline def onScrollListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onScrollListener'")
    ...
    @noEquivalentGetterExists
    @inline def recyclerListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'recyclerListener'")
  ...
  trait TraitViewGroup[V <: android.view.ViewGroup] extends TraitView[V] {
    ...
    @noEquivalentGetterExists
    @inline def clipChildren(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'clipChildren'")
    @inline def clipChildren  (p: Boolean) =            clipChildren_=  (p)
    @inline def clipChildren_=(p: Boolean) = { basis.setClipChildren    (p); basis }

    @noEquivalentGetterExists
    @inline def clipToPadding(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'clipToPadding'")
    ...
    @noEquivalentGetterExists
    @inline def onHierarchyChangeListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onHierarchyChangeListener'")
  ...
  trait TraitFrameLayout[V <: android.widget.FrameLayout] extends TraitViewGroup[V] {
    ...
    @noEquivalentGetterExists
    @inline def foregroundGravity(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'foregroundGravity'")
    ...
    @noEquivalentGetterExists
    @inline def measureAllChildren(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'measureAllChildren'")
  ...
  trait TraitRelativeLayout[V <: android.widget.RelativeLayout] extends TraitViewGroup[V] {
    ...
    @noEquivalentGetterExists
    @inline def gravity(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'gravity'")
    @inline def gravity  (p: Int) =            gravity_=  (p)
    @inline def gravity_=(p: Int) = { basis.setGravity    (p); basis }

    @noEquivalentGetterExists
    @inline def horizontalGravity(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'horizontalGravity'")
    ...
    @noEquivalentGetterExists
    @inline def ignoreGravity(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'ignoreGravity'")
    @inline def ignoreGravity  (p: Int) =            ignoreGravity_=  (p)
    @inline def ignoreGravity_=(p: Int) = { basis.setIgnoreGravity    (p); basis }

    @noEquivalentGetterExists
    @inline def verticalGravity(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'verticalGravity'")
  ...
  class SLinearLayout(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends LinearLayout(context) with TraitLinearLayout[SLinearLayout] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  class SExtractEditText(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
  ...
  trait TraitAutoCompleteTextView[V <: android.widget.AutoCompleteTextView] extends TraitEditText[V] {
    ...
    @noEquivalentGetterExists
    @inline def completionHint(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'completionHint'")
    ...
    @noEquivalentGetterExists
    @inline def dropDownBackgroundDrawable(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'dropDownBackgroundDrawable'")
    ...
    @noEquivalentGetterExists
    @inline def dropDownBackgroundResource(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'dropDownBackgroundResource'")
  ...
  class SAutoCompleteTextView(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends AutoCompleteTextView(context) with TraitAutoCompleteTextView[SAutoCompleteTextView] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  trait TraitListView[V <: android.widget.ListView] extends TraitAbsListView[V] {
    ...
    @noEquivalentGetterExists
    @inline def footerDividersEnabled(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'footerDividersEnabled'")
    ...
    @noEquivalentGetterExists
    @inline def headerDividersEnabled(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'headerDividersEnabled'")
  ...
  class SListView(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends ListView(context) with TraitListView[SListView] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SListView {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SListView]]()
        (implicit context: Context, defaultLayoutParam: (SListView) => LP): SListView = {
      val v = (new SListView)
      v.<<.parent.+=(v)
      v
    }
  ...
  class SButton(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
  ...
  trait TraitCompoundButton[V <: android.widget.CompoundButton] extends TraitButton[V] {
    ...
    @noEquivalentGetterExists
    @inline def buttonDrawable(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'buttonDrawable'")
    ...
    @noEquivalentGetterExists
    @inline def onCheckedChangeListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onCheckedChangeListener'")
  ...
  class SCheckBox(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
  ...
  class SRadioButton(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
  ...
  class SToggleButton(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
  ...
  trait TraitCheckedTextView[V <: android.widget.CheckedTextView] extends TraitTextView[V] {
    ...
    @noEquivalentGetterExists
    @inline def checkMarkDrawable(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'checkMarkDrawable'")
  ...
  class SCheckedTextView(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
  ...
  class SChronometer(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends Chronometer(context) with TraitChronometer[SChronometer] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  class SDigitalClock(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
  ...
  trait TraitKeyboardView[V <: android.inputmethodservice.KeyboardView] extends TraitView[V] {
    ...
    @noEquivalentGetterExists
    @inline def onKeyboardActionListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onKeyboardActionListener'")
    ...
    @noEquivalentGetterExists
    @inline def popupParent(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'popupParent'")
    ...
    @noEquivalentGetterExists
    @inline def verticalCorrection(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'verticalCorrection'")
  ...
  trait TraitImageView[V <: android.widget.ImageView] extends TraitView[V] {
    ...
    @noEquivalentGetterExists
    @inline def adjustViewBounds(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'adjustViewBounds'")
    ...
    @noEquivalentGetterExists
    @inline def alpha(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'alpha'")
    ...
    @noEquivalentGetterExists
    @inline def imageBitmap(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'imageBitmap'")
    ...
    @noEquivalentGetterExists
    @inline def imageDrawable(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'imageDrawable'")
    ...
    @noEquivalentGetterExists
    @inline def imageLevel(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'imageLevel'")
    ...
    @noEquivalentGetterExists
    @inline def imageResource(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'imageResource'")
    @inline def imageResource  (p: Int) =            imageResource_=  (p)
    @inline def imageResource_=(p: Int) = { basis.setImageResource    (p); basis }

    @noEquivalentGetterExists
    @inline def imageURI(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'imageURI'")
  ...
  class SImageView(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends ImageView(context) with TraitImageView[SImageView] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  class SImageButton(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
  ...
  trait TraitQuickContactBadge[V <: android.widget.QuickContactBadge] extends TraitImageView[V] {
    ...
    @noEquivalentGetterExists
    @inline def excludeMimes(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'excludeMimes'")
    ...
    @noEquivalentGetterExists
    @inline def mode(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'mode'")
    @inline def mode  (p: Int) =            mode_=  (p)
    @inline def mode_=(p: Int) = { basis.setMode    (p); basis }

  }

  class SQuickContactBadge(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends QuickContactBadge(context) with TraitQuickContactBadge[SQuickContactBadge] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  trait TraitZoomButton[V <: android.widget.ZoomButton] extends TraitImageButton[V] {
    ...
    @noEquivalentGetterExists
    @inline def zoomSpeed(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'zoomSpeed'")
    @inline def zoomSpeed  (p: Long) =            zoomSpeed_=  (p)
    @inline def zoomSpeed_=(p: Long) = { basis.setZoomSpeed    (p); basis }

  }

  class SZoomButton(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends ZoomButton(context) with TraitZoomButton[SZoomButton] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  class SProgressBar(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends ProgressBar(context) with TraitProgressBar[SProgressBar] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SProgressBar {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SProgressBar]]()
        (implicit context: Context, defaultLayoutParam: (SProgressBar) => LP): SProgressBar = {
  ...
  class SAnalogClock(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
  ...
  object SAnalogClock {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SAnalogClock]]()
        (implicit context: Context, defaultLayoutParam: (SAnalogClock) => LP): SAnalogClock = {
  ...
  trait TraitSurfaceView[V <: android.view.SurfaceView] extends TraitView[V] {
    ...
    @noEquivalentGetterExists
    @inline def ZOrderMediaOverlay(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'ZOrderMediaOverlay'")
    ...
    @noEquivalentGetterExists
    @inline def ZOrderOnTop(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'ZOrderOnTop'")
  ...
  class SSurfaceView(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends SurfaceView(context) with TraitSurfaceView[SSurfaceView] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SSurfaceView {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SSurfaceView]]()
        (implicit context: Context, defaultLayoutParam: (SSurfaceView) => LP): SSurfaceView = {
  ...
  trait TraitGLSurfaceView[V <: android.opengl.GLSurfaceView] extends TraitSurfaceView[V] {
    ...
    @noEquivalentGetterExists
    @inline def EGLConfigChooser(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'EGLConfigChooser'")
    ...
    @noEquivalentGetterExists
    @inline def EGLContextClientVersion(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'EGLContextClientVersion'")
    ...
    @noEquivalentGetterExists
    @inline def EGLContextFactory(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'EGLContextFactory'")
    ...
    @noEquivalentGetterExists
    @inline def EGLWindowSurfaceFactory(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'EGLWindowSurfaceFactory'")
    ...
    @noEquivalentGetterExists
    @inline def GLWrapper(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'GLWrapper'")
    ...
    @noEquivalentGetterExists
    @inline def renderer(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'renderer'")
  ...
  class SGLSurfaceView(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends GLSurfaceView(context) with TraitGLSurfaceView[SGLSurfaceView] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SGLSurfaceView {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SGLSurfaceView]]()
        (implicit context: Context, defaultLayoutParam: (SGLSurfaceView) => LP): SGLSurfaceView = {
  ...
  trait TraitVideoView[V <: android.widget.VideoView] extends TraitSurfaceView[V] {
    ...
    @noEquivalentGetterExists
    @inline def mediaController(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'mediaController'")
    ...
    @noEquivalentGetterExists
    @inline def onCompletionListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onCompletionListener'")
    ...
    @noEquivalentGetterExists
    @inline def onErrorListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onErrorListener'")
    ...
    @noEquivalentGetterExists
    @inline def onPreparedListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onPreparedListener'")
    ...
    @noEquivalentGetterExists
    @inline def videoPath(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'videoPath'")
    @inline def videoPath  (p: java.lang.String) =            videoPath_=  (p)
    @inline def videoPath_=(p: java.lang.String) = { basis.setVideoPath    (p); basis }

    @noEquivalentGetterExists
    @inline def videoURI(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'videoURI'")
  ...
  class SVideoView(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends VideoView(context) with TraitVideoView[SVideoView] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SVideoView {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SVideoView]]()
        (implicit context: Context, defaultLayoutParam: (SVideoView) => LP): SVideoView = {
  ...
  trait TraitViewStub[V <: android.view.ViewStub] extends TraitView[V] {
    ...
    @noEquivalentGetterExists
    @inline def onInflateListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onInflateListener'")
  ...
  trait TraitGridView[V <: android.widget.GridView] extends TraitAbsListView[V] {
    ...
    @noEquivalentGetterExists
    @inline def columnWidth(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'columnWidth'")
    ...
    @noEquivalentGetterExists
    @inline def horizontalSpacing(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'horizontalSpacing'")
    ...
    @noEquivalentGetterExists
    @inline def numColumns(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'numColumns'")
    ...
    @noEquivalentGetterExists
    @inline def verticalSpacing(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'verticalSpacing'")
    @inline def verticalSpacing  (p: Int) =            verticalSpacing_=  (p)
    @inline def verticalSpacing_=(p: Int) = { basis.setVerticalSpacing    (p); basis }

  }

  class SGridView(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends GridView(context) with TraitGridView[SGridView] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SGridView {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SGridView]]()
        (implicit context: Context, defaultLayoutParam: (SGridView) => LP): SGridView = {
      val v = (new SGridView)
      v.<<.parent.+=(v)
      v
    }
  ...
  trait TraitExpandableListView[V <: android.widget.ExpandableListView] extends TraitListView[V] {
    ...
    @noEquivalentGetterExists
    @inline def childDivider(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'childDivider'")
    ...
    @noEquivalentGetterExists
    @inline def childIndicator(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'childIndicator'")
    ...
    @noEquivalentGetterExists
    @inline def groupIndicator(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'groupIndicator'")
    ...
    @noEquivalentGetterExists
    @inline def onChildClickListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onChildClickListener'")
    ...
    @noEquivalentGetterExists
    @inline def onGroupClickListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onGroupClickListener'")
    ...
    @noEquivalentGetterExists
    @inline def onGroupCollapseListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onGroupCollapseListener'")
    ...
    @noEquivalentGetterExists
    @inline def onGroupExpandListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onGroupExpandListener'")
    ...
    @noEquivalentGetterExists
    @inline def selectedGroup(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'selectedGroup'")
  ...
  class SExpandableListView(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends ExpandableListView(context) with TraitExpandableListView[SExpandableListView] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SExpandableListView {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SExpandableListView]]()
        (implicit context: Context, defaultLayoutParam: (SExpandableListView) => LP): SExpandableListView = {
  ...
  trait TraitSpinner[V <: android.widget.Spinner] extends TraitAbsSpinner[V] {
    ...
    @noEquivalentGetterExists
    @inline def promptId(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'promptId'")
    @inline def promptId  (p: Int) =            promptId_=  (p)
    @inline def promptId_=(p: Int) = { basis.setPromptId    (p); basis }

  }

  class SSpinner(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends Spinner(context) with TraitSpinner[SSpinner] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SSpinner {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SSpinner]]()
        (implicit context: Context, defaultLayoutParam: (SSpinner) => LP): SSpinner = {
      val v = (new SSpinner)
      v.<<.parent.+=(v)
      v
    }
  ...
  trait TraitGallery[V <: android.widget.Gallery] extends TraitAbsSpinner[V] {
    ...
    @noEquivalentGetterExists
    @inline def animationDuration(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'animationDuration'")
    ...
    @noEquivalentGetterExists
    @inline def callbackDuringFling(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'callbackDuringFling'")
    ...
    @noEquivalentGetterExists
    @inline def spacing(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'spacing'")
    @inline def spacing  (p: Int) =            spacing_=  (p)
    @inline def spacing_=(p: Int) = { basis.setSpacing    (p); basis }

    @noEquivalentGetterExists
    @inline def unselectedAlpha(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'unselectedAlpha'")
  ...
  class SGallery(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends Gallery(context) with TraitGallery[SGallery] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SGallery {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SGallery]]()
        (implicit context: Context, defaultLayoutParam: (SGallery) => LP): SGallery = {
      val v = (new SGallery)
      v.<<.parent.+=(v)
      v
    }
  ...
  trait TraitAbsSeekBar[V <: android.widget.AbsSeekBar] extends TraitProgressBar[V] {
    ...
    @noEquivalentGetterExists
    @inline def thumb(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'thumb'")
  ...
  trait TraitSeekBar[V <: android.widget.SeekBar] extends TraitAbsSeekBar[V] {
    ...
    @noEquivalentGetterExists
    @inline def onSeekBarChangeListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onSeekBarChangeListener'")
  ...
  class SSeekBar(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends SeekBar(context) with TraitSeekBar[SSeekBar] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SSeekBar {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SSeekBar]]()
        (implicit context: Context, defaultLayoutParam: (SSeekBar) => LP): SSeekBar = {
      val v = (new SSeekBar)
      v.<<.parent.+=(v)
      v
    }
  ...
  class SRatingBar(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends RatingBar(context) with TraitRatingBar[SRatingBar] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SRatingBar {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SRatingBar]]()
        (implicit context: Context, defaultLayoutParam: (SRatingBar) => LP): SRatingBar = {
  ...
  class SHorizontalScrollView(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends HorizontalScrollView(context) with TraitHorizontalScrollView[SHorizontalScrollView] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SHorizontalScrollView {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SHorizontalScrollView]]()
        (implicit context: Context, defaultLayoutParam: (SHorizontalScrollView) => LP): SHorizontalScrollView = {
  ...
  trait TraitMediaController[V <: android.widget.MediaController] extends TraitFrameLayout[V] {
    ...
    @noEquivalentGetterExists
    @inline def anchorView(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'anchorView'")
    ...
    @noEquivalentGetterExists
    @inline def mediaPlayer(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'mediaPlayer'")
  ...
  class SMediaController(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends MediaController(context) with TraitMediaController[SMediaController] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SMediaController {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SMediaController]]()
        (implicit context: Context, defaultLayoutParam: (SMediaController) => LP): SMediaController = {
  ...
  class SScrollView(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends ScrollView(context) with TraitScrollView[SScrollView] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SScrollView {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SScrollView]]()
        (implicit context: Context, defaultLayoutParam: (SScrollView) => LP): SScrollView = {
  ...
  trait TraitTabHost[V <: android.widget.TabHost] extends TraitFrameLayout[V] {
    ...
    @noEquivalentGetterExists
    @inline def currentTabByTag(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'currentTabByTag'")
    ...
    @noEquivalentGetterExists
    @inline def onTabChangedListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onTabChangedListener'")
    ...
    @noEquivalentGetterExists
    @inline def up(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'up'")
  ...
  class STabHost(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends TabHost(context) with TraitTabHost[STabHost] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object STabHost {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, STabHost]]()
        (implicit context: Context, defaultLayoutParam: (STabHost) => LP): STabHost = {
      val v = (new STabHost)
      v.<<.parent.+=(v)
      v
    }
  ...
  trait TraitTimePicker[V <: android.widget.TimePicker] extends TraitFrameLayout[V] {
    ...
    @noEquivalentGetterExists
    @inline def onTimeChangedListener(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'onTimeChangedListener'")
  ...
  class STimePicker(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends TimePicker(context) with TraitTimePicker[STimePicker] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object STimePicker {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, STimePicker]]()
        (implicit context: Context, defaultLayoutParam: (STimePicker) => LP): STimePicker = {
  ...
  trait TraitViewAnimator[V <: android.widget.ViewAnimator] extends TraitFrameLayout[V] {
    ...
    @noEquivalentGetterExists
    @inline def animateFirstView(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'animateFirstView'")
  ...
  class SViewAnimator(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends ViewAnimator(context) with TraitViewAnimator[SViewAnimator] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SViewAnimator {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SViewAnimator]]()
        (implicit context: Context, defaultLayoutParam: (SViewAnimator) => LP): SViewAnimator = {
  ...
  trait TraitViewFlipper[V <: android.widget.ViewFlipper] extends TraitViewAnimator[V] {
    ...
    @noEquivalentGetterExists
    @inline def flipInterval(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'flipInterval'")
  ...
  class SViewFlipper(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends ViewFlipper(context) with TraitViewFlipper[SViewFlipper] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SViewFlipper {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SViewFlipper]]()
        (implicit context: Context, defaultLayoutParam: (SViewFlipper) => LP): SViewFlipper = {
  ...
  trait TraitViewSwitcher[V <: android.widget.ViewSwitcher] extends TraitViewAnimator[V] {
    ...
    @noEquivalentGetterExists
    @inline def factory(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'factory'")
  ...
  class SViewSwitcher(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends ViewSwitcher(context) with TraitViewSwitcher[SViewSwitcher] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SViewSwitcher {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SViewSwitcher]]()
        (implicit context: Context, defaultLayoutParam: (SViewSwitcher) => LP): SViewSwitcher = {
  ...
  class SImageSwitcher(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends ImageSwitcher(context) with TraitImageSwitcher[SImageSwitcher] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SImageSwitcher {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SImageSwitcher]]()
        (implicit context: Context, defaultLayoutParam: (SImageSwitcher) => LP): SImageSwitcher = {
  ...
  trait TraitTextSwitcher[V <: android.widget.TextSwitcher] extends TraitViewSwitcher[V] {
    ...
    @noEquivalentGetterExists
    @inline def currentText(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'currentText'")
    ...
    @noEquivalentGetterExists
    @inline def text(implicit no: Nothing)  = throw new Error("Android does not support the getter for 'text'")
    @inline def text  (p: java.lang.CharSequence) =            text_=  (p)
    @inline def text_=(p: java.lang.CharSequence) = { basis.setText    (p); basis }

  }

  class STextSwitcher(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends TextSwitcher(context) with TraitTextSwitcher[STextSwitcher] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object STextSwitcher {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, STextSwitcher]]()
        (implicit context: Context, defaultLayoutParam: (STextSwitcher) => LP): STextSwitcher = {
  ...
  class SDatePicker(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends DatePicker(context) with TraitDatePicker[SDatePicker] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SDatePicker {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SDatePicker]]()
        (implicit context: Context, defaultLayoutParam: (SDatePicker) => LP): SDatePicker = {
  ...
  class SGestureOverlayView(implicit context: Context, parentVGroup: TraitViewGroup[_] = null)
      extends GestureOverlayView(context) with TraitGestureOverlayView[SGestureOverlayView] {
    def basis = this
    override val parentViewGroup = parentVGroup
  ...
  object SGestureOverlayView {
    ...
    def apply[LP <: ViewGroupLayoutParams[_, SGestureOverlayView]]()
        (implicit context: Context, defaultLayoutParam: (SGestureOverlayView) => LP): SGestureOverlayView = {
